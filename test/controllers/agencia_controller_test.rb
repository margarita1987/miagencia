...
class AgenciaControllerTest < ActionController::TestCase
  ...
  test "should create agencium" do
    assert_difference('Agencium.count') do
      post :create, agencium: { fecha: @agencium.fecha, mensaje: @agencium.mensaje, usuario: @agencium.usuario }
    end
  ...
  test "should update agencium" do
    patch :update, id: @agencium, agencium: { fecha: @agencium.fecha, mensaje: @agencium.mensaje, usuario: @agencium.usuario }
    assert_redirected_to agencium_path(assigns(:agencium))
  end
